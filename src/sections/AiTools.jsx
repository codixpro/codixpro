        ...
        <div className="p-2 flex flex-col items-center justify-center bg-black text-white "> {/* removed bg-black */}
            ...
            >
                <div className="flex flex-col md:justify-start md:w-1/2 md:items-start items-center">
                    <h1 className="text-4xl font-bold mb-2 ">AI-Powered Business Tools</h1>
                    <p className="text-gray-300 max-w-md mb-2">Powerful tools designed to simplify your operations, boost productivity, and drive growth for your business.</p>
